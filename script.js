    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "א.א עבודות קידוחים ופיתוח משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'cc372836-b5ca-4abc-9cbb-9bb0164dbd5e',
                    name: data.name || '',
                    email: data.email || '',
